...
// Task 01 >> iki tane int deger alan toplayip return eden method create ediniz .
    ...
    public static void topla3(){
        int a=55;
        int b=9;
        System.out.println(a+b);
        System.out.println("toplam 3 methoddan sevgiler");
        topla();//method call edildi
    }

    public static int topla2(int sayi1, int sayi2) {//Task 01 deki method create edildi
        int toplam = sayi1 + sayi2;


        return toplam;//en son kod olmalı
    }
    ...
    static void topla() {//method create edildi
        ...
        int b = 44;
        System.out.println(a + b);
        System.out.println("toplam isimli method çalıştı");
