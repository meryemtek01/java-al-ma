package ch24_Encapsulation.encapsulationc01;
/*
...
public class C01_Encapsulation {
    public static void main(String[] args) {
        ...
        System.out.println("obj1.getName() = " + obj1.getName());//obj1.getName() = null

        C02_Encapsulation obj2 = new C02_Encapsulation(1001, "Rümeysa");//

        System.out.println("obj2.getId() = " + obj2.getId());//obj2.getId() = 1001
        System.out.println("obj2.getName() = " + obj2.getName());//obj2.getName() = Rümeysa


        obj1.setName("Safak hanım");
        System.out.println("obj1.getName() = " + obj1.getName());//obj1.getName() = null
        obj2.setName("furkan bey");
        System.out.println("obj2.getName() = " + obj2.getName());//obj2.getName() = furkan bey
