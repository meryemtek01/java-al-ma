package ch04_JavaOperators.jo01_aritmetikOperators.jo04;
 ...
 */
        ...
        //and ve pesimiste &
        System.out.println("b1&(a<b)="+(b1&(a<b)));// true  (a<b) a beden küçük mü true veya false
        System.out.println("b2&(a<b)="+(b2&&(a<b)));//false b2&(a<b)=false

        //Or veya optimist ||

        System.out.println("(b1 || (a < b)"+(b1 || (a < b))); //(b1 || (a < b)true
        System.out.println("(b2 || (a < b)"+(b1 || (a < b)));// (b2 || (a < b)true

        //not !
        System.out.println("(!b1||(a<b)) not  "+(!b1 || (a < b)));//(!b1||(a<b)) not  true
        System.out.println("b1 = "+b1);//b1 = true
