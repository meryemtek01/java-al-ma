package ch04_JavaOperators.jo01_aritmetikOperators.jo03_ComparisonOperators;
...
public class C01_ComparisonOperators {
  ...
  Unlem isareti (!) olumsuzluk anlaminda kullanilir.
     */
       ...
       /* int yas1 = 34;
        int yas2 = 55;
        //task yas1 ile yas2 nin eşit olup olmadıgını kontrol eder
        System.out.println("yas1 == yas2  "+(yas1 == yas2  ));// yas1 ile yas2 nin eşit olup olmadıgını kontrol eder

//olumsuz kontrol nasıl yapılır
        System.out.println("yas1!=yas2  "+(yas1!=yas2));//true
  */
