...
public class Employee {
    ...
    public double tax() {//vergi hesaplama
        ...
        double paymentOfTex = 0;
        if (salary < 10000) {
            System.out.println("vergiden muafsin ama sevinme gözüm üstünde");
        } else {
            paymentOfTex = salary * 0.03;
    ...
    public int bonus() {//bonus hesaplama
    ...
    public double raiseSalary() {//artış miktarını hesaplar
        int timeOfYear = 2023;
