 ...
 */
        StringBuilder sb1=new StringBuilder("javaAslan");
        StringBuilder sb2=new StringBuilder("javaAslan");
        String s="javaAslan";
       ...
       //CTE System.out.println("sb2.compareTo(s) = " + sb2.compareTo(s));
        ...
        //sb1 ve sb2 yi equals ile karşılaştırıp asıl true yapabiliriz
        System.out.println("sb1.toString().equals(sb2.toString()) = " + sb1.toString().equals(sb2.toString()));
        //sb1.toString().equals(sb2.toString()) = true strig voue re çalışıyor
