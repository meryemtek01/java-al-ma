...
public class MarketProject {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ortalama kazancın " +
                "altındaki gunler : "+getOrtalamaninAltindaKazancGünleri());

    }//main sonu

    private static ArrayList<String> getOrtalamaninAltindaKazancGünleri() {
ArrayList<String>  ortalamaAltıGun = new ArrayList<String>();
    ...
    private static ArrayList<String> getOrtalamaninUstundeKazancGünleri() {//5. adım
        ArrayList<String>  ortalamaUstuGun = new ArrayList<String>();
