...
/* java escape special characters -> https://www.w3schools.com/java/java_strings_specchars.asp
   ...
   /*
        ...
        System.out.println("Hello , " + "World  \\ /"); //  Soru-1 :   konsola      "Hello ", "World  \ /"
        System.out.println("p\na\nz\na\nr\nt\ne\ns\ni"); //Soru-2 : Pazartesi kelimesini her harfini ayrı bir satira gelecek sekilde yazdırınız.
        System.out.println("Java" + "ile hayat cok" + "'afilli'");//Soru-3 : "Java" ile hayat cok 'afilli'
        //Soru-4 : "Basari" gayreti 'sever'  yazdırınız sonraki "Clarusway ile java cok kolay ..." ifadesi  3 satır sonra ve satır basından 1 tab ileride yazılsın.
